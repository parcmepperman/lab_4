...
for i, direct in zip(all_data, dirs):
    all_data[i] = unpickle(CIFAR_DIR + direct)
...
def one_hot_encode(vec, values=10):
    n = len(vec)
...
class CifarHelper():
    ...
    def set_up_images (self):
        ...
        # vertical stacks the training images
...
with tf.Session() as sess:
    ...
    for i in range(300):
        ...
        if i % 100 == 0:
            ...
            print("Matches", sess.run(acc, feed_dict={x: ch.test_images, y_true: ch.test_labels, hold_prob: 1.0}))
